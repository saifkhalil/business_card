...
class BusinessRequest(models.Model):
    ...
    first_name_en = models.CharField(
        max_length=250, blank=False, null=False, verbose_name='First Name En')
    last_name_en = models.CharField(
        max_length=250, blank=True, null=True, verbose_name='Last Name En')
    first_name_ar = models.CharField(
        max_length=250, blank=False, null=False, verbose_name='First Name Ar')
    last_name_ar = models.CharField(
        max_length=250, blank=True, null=True, verbose_name='last Name Ar')
    job_title = models.CharField(
        max_length=250, blank=False, null=False, verbose_name='Job Title En')
    job_title_ar = models.CharField(
        max_length=250, blank=False, null=False, verbose_name='Job Title Ar')
    ...
    status_change_at = models.DateTimeField(
        editable=False, null=True, blank=True, verbose_name='Status Change By')
