...
class BusinessRequest(models.Model):
    ...
    last_name_en = models.CharField(max_length=250, blank=False, null=False, verbose_name='Last Name En')
    first_name_ar = models.CharField(max_length=250, blank=False, null=False, verbose_name='First Name Ar')
    last_name_ar = models.CharField(max_length=250, blank=False, null=False, verbose_name='last Name Ar')
